...
<!--    <script defer src="https://use.fontawesome.com/releases/v5.0.6/js/all.js"></script>-->
    ...
    <script src="js/jquery-ui-1.12.1.custom/jquery-ui-1.12.1.custom/external/jquery/jquery.js"></script>
...
<body>
    ...
    <main>
        <div class="registrationForm">
            ...
            <input class="registrationInput" type="text" id="name" placeholder="Name">
            <p>Введите телефонный номер</p>
            <input class="registrationInput" type="text" id="number" placeholder="+7(000)000-0000">
            <p>Введите адрес электронной почты</p>
            <input class="registrationInput" type="text" id="eMail" placeholder="E-mail: aaaa@aaaa.ru">
            
            <p>Выберите дату своего рождения</p>
            <input type="text" id="datepicker" class="registrationInput">
            
           
            <button id="registrationBtn">Отправить</button>
        </div>
<!--        Диалоговые окна-->
        <div class="dialogWindows" style="display: none">
            <div id="dialogName" title="Имя">
              <p>Имя должно содержать только буквы.</p>
            </div>
            <div id="dialogTel" title="Телефонный номер">
              <p>Номер телефона может должен быть записан в формате: +7(000)000-0000.</p>
            </div>
            <div id="dialogEmail" title="Адрес электронной почты">
              <p>Электронный адрес должен записываться ввиде: aaaa@aaaa.com</p>
            </div>
            datepickerDialog
            <div id="datepickerDialog" title="Адрес электронной почты">
              <p>Пожалуйста выберите дату своего рождения</p>
            </div>
        </div>
    </main>
    ...
    <section class="bot_nav conteiner">
        <div class="brand_discr ">
            ...
            <h7> Objectively transition extensive data rather than cross functional solutions. Monotonectally syndicate multidiscipinary materials before go forward benefits. Intrinsicly syndicate an explanded array of processes and cross-unit partnerships.
            </h7>
        </div>
        <nav class="company">
            <a href="#">
