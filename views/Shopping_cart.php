...
<body>
	...
	<main class="conteiner">
		<div class="m_table">
			<div class="row_names">
			    <h4 class="cell1">PRODUCT DETAILS</h4>
			    <div class="cell2"></div>
			    <h4 class="cell3">UNITE PRICE</h4>
			    <h4 class="cell4">QUANTITY</h4> 
			    <h4 class="cell5">SHIPPING</h4>
			    <h4 class="cell6">SUBTOTAL</h4>
			    <h4 class="cell7">ACTION</h4>
			</div>
			<div class="m_table_prod">
			    <div class="prod_img">
			        <img src="img/shop_cart_1.jpg" alt="men" class="cell1">
			    </div>
			    <div class="prod_name cell2">
			        <h4>Mango  People  T-shirt</h4>
			        <div class="prod_name_descr"> 
                        <h6>Color: <span>Red</span></h6>
                        <h6>Size: <span>XLL</span></h6>
			        </div>
			    </div>
			    <div class="prod_price cell3">
			        <h5>&#36;150</h5>
			    </div>
			    <div class="prod_q cell4">
			        <h5>2</h5>
			    </div>
			    <div class="prod_shipping cell5">
			        <h5>FREE</h5>
			    </div>
			    <div class="prod_subtotal cell6">
			        <h5>&#36;300</h5>
			    </div>
			    <div class="prod_action cell7">
			     <img src="img/delite.png" alt="del">
			    </div>
			</div>
			<div class="m_table_prod">
			    <div class="prod_img">
		...
		<div class="clear_continue_sopping">
		    <div class="clear_shopping_cart"><a href="#"><h3>CLEAR SHOPPING CART</h3></a></div>
		    <div class="continue_shopping"><a href="#"><h3>CONTINUE SHOPPING</h3></a></div>
		</div>
	</main>
