...
<body>
    ...
    <nav>
        <ul class="conteiner menu_nav">
            ...
            <li class="menu_nav_a"><a href="Chekout.php" class="menu_nav_a" id="border_nav">Chekout</a></li>
        </ul>
    </nav>
    <main>
        ...
        <section class="list conteiner">
            <article class="shipping_adress">
                ...
                <div class="shipping_adress_flex">
                    <div class="guest_check">
                        <h5>CHEK AS A GUEST OR REGISTER</h5>
                        <h6>Register with us for future convenience</h6>
                        <div class="guest_check_AS_GUEST">
                            <input type="radio"><span>CHECKOUT AS GUEST</span>
                        </div>
                        <div class="guest_check_REGISTER">
                            <input type="radio"><span>REGISTER</span>
                        </div>
                        <h5 class="registrationLink">REGISTER AND SAVE TIME!</h5>
                        <h6>Register with us for future convenience</h6>
                        <h6>>>Fast and easy checkout <br>>>Easy access to your order history and status</h6>

                        <a href="registration.php" class="shipping_adress_buttons">CONTINUE</a>

                    </div>
                    <div class="registred_form">
                        <h5>ALREADY REGISTED?</h5>
                        <h6>Please log in below</h6>
                        <h5>EMAIL ADRESS <span>*</span></h5>
                        <input type="email">
                        <h5>PASSWORD<span>*</span></h5>
                        <input type="text">
                        <h6><span>Reqired Fileds*</span></h6>
                        <a href="#" class="shipping_adress_buttons">LOG IN</a>
                        <a href="#" class="registred_form_link">Forgot Password ?</a>
                    </div>
                </div>
            </article>
            <article class="billing_info">
                <h2>02. BILLING INFORMATION</h2>
            </article>
            <article class="shipping_info">
                <h2>03. SHIPPING INFORMATION</h2>
            </article>
            <article class="shipping_method">
                <h2>04. SHIPPING METHOD</h2>
            </article>
            <article class="payment">
                <h2>05. PAYMENT METHOD</h2>
            </article>
            <article class="order_review">
