...
<body>
    ...
    <nav>
        <ul class="conteiner menu_nav">
            ...
            <li class="menu_nav_a"><a href="Single_page.php" id="border_nav">women</a></li>
    ...
    <main class="main_product  s_page">
        <div class="W_slider"> <img src="img/w_slider.jpg" alt="woman"> </div>
        <div class="conteiner">
            <div class="Moschino_Cheap">
                <div class="w_collection">
                    <h4>WOMAN COLLECTION</h4> <img src="img/Wcollection_border.jpg" alt="border"> </div>
                <div class="mosh_chip">
                    <h2>Moschino Cheap And Chic</h2>
                    <h6>Compellingly actualize fully researched processes before proactive outsourcing. Progressively syndicate collaborative architectures before cutting-edge services. Completely visualize parallel core competencies rather than exceptional portals.</h6> </div>
                <div class="mosh_chip_m_d">
                    <div class="mosh_chip_material">
                        <h3><span>MATERIAL:</span> COTTON</h3></div>
                    <div class="mosh_chip_designer">
                        <h3><span>DESIGNER:</span> BINBURHAN</h3></div>
                </div>
                <div class="mosh_chip_price">
                    <h2>&#36;561</h2> </div>
                <div class="Moschino_Cheap_chooses">
                    <div class="Moschino_Cheap_choose_color">
                        <h3>CHOOSE COLOR</h3>
<!--
                        <div class="Moschino_Cheap_choose_color_ul">
                            <a href="#" id="Moschino_Cheap_choose_color_ul_open">Red</a>
                            <ul id="Moschino_Cheap_choose_color_ul_hidden">
                                <li><a href="#">Blue</a></li>
...
-->
                    ...
                    <div class="Moschino_Cheap_choose_size">
                        <h3>CHOOSE SIZE</h3></div>
                    <div class="Moschino_Cheap_choose_quantity">
                        <h3>QUANTITY</h3>
                    </div>
                     
                </div>
                <div class="all_prod" id="Moschino_Cheap_add">
                        <a href="#">
                           <img src="img/cart_red.svg" alt="basket">
            ...
            <div class="Y_may_l">
                    ...
                    <div class="Y_may_l_cards">
                        <div class="Y_may_l_cards"></div>
                        <div class="product_1">
                        <a href="#" class="product_1_link"> <img src="img/women1.jpg" alt="Mango  People  T-shirt">
                        ...
                        <div class="add_to_cart">
                            <a href="123" class="add_to_cart_link"> <img class="add_to_cart_img" src="img/add_2_cart.png" alt="add_2_cart">
                                <h5>Add To Cart</h5> </a>
                        </div>
                    </div> 
          
                        <div class="product_1">
                <a href="#" class="product_1_link"> <img src="img/women3.jpg" alt="Mango  People  T-shirt">
                    <div class="product_dscr">
                        <h3>Mango  People  T-shirt</h3> </div>
                    <div class="product_prise">
                        <h3>$52.00</h3> </div>
                ...
                <div class="add_to_cart">
                    <a href="123" class="add_to_cart_link"> <img class="add_to_cart_img" src="img/add_2_cart.png" alt="add_2_cart">
                        ...
                        <div class="product_1">
                <a href="#" class="product_1_link"> <img src="img/women4.jpg" alt="Mango  People  T-shirt">
                    <div class="product_dscr">
                        <h3>Mango  People  T-shirt</h3> </div>
                    <div class="product_prise">
                        <h3>$52.00</h3> </div>
